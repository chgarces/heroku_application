...
if __name__ == "__main__":
    ...
    # TODO matching before create need a field to let the system know if the search has been completed.
    # manage_create_records(session, query_stage_contacts(session, "EMAIL FIELDS", "IN PROGRESS")):

    # group_contacts_by_client_type(loadSession())
    # pass
